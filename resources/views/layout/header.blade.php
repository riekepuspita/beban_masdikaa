    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu"
                ...
                data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true"
            ...
            <div class="app-navbar flex-shrink-0">
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <img src="{{ asset('media/logos/Profil.jpg') }}" alt="Profil" />
                    </div>
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                                        {{-- <a href="{{ route('produkhukum') }}"> --}}
                                            <img alt="Profil" src="{{ asset('media/logos/Profil.jpg') }}" class="h-70px app-sidebar-logo-default" />
                                        </a>
                                    </div>
                            ...
                            @auth
                                ...
                                <form action="/logout" method="post">
                                    ...
                                    <button type="submit" class="dropdown-item">
                                        <p class="menu-link px-5">Log out</p>
                                    </button>
                                </form>
                                {{-- @else --}}
                                {{-- Jika belum login tampilkan login --}}
                                {{-- <a href="{{ route('login') }}" class="menu-link px-5">Log in</a> --}}
                            @endauth
