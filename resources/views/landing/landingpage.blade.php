                                    ...
                                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-semibold"
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#achievements"
                                                ...
                                                data-kt-drawer-dismiss="true">Produk Hukum</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#team"
                                                data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Informasi Hukum</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#portfolio"
                                                data-kt-scroll-toggle="true"
                                                data-kt-drawer-dismiss="true">Kegiatan Hukum</a>
                                            <!--end::Menu link-->
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                ...
                {{-- <div class="row w-100 gy-10 mb-md-20">
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="{{ asset('/media/illustrations/sketchy-1/2.png') }}" class="mh-125px mb-9"
                                alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="{{ asset('/media/illustrations/sketchy-1/8.png') }}" class="mh-125px mb-9"
                                alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                            <div class="d-flex flex-center mb-5">
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="{{ asset('/media/illustrations/sketchy-1/12.png') }}" class="mh-125px mb-9"
                                alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                            <div class="d-flex flex-center mb-5">
                ...
                <div class="tns tns-default">
                    ...
                    {{-- <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                        ...
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{ asset('/media/product-demos/demo1.png') }}"
                                class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{ asset('/media/product-demos/demo2.png') }}"
                                class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{ asset('/media/product-demos/demo4.png') }}"
                                class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{ asset('/media/product-demos/demo5.png') }}"
                                class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                    </div> --}}
                                ...
                                <div class="row g-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay h-lg-100"
                                            ...
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                style="background-image:url('/media/stock/600x600/img-23.jpg')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row g-10 mb-10">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <a class="d-block card-rounded overlay"
                                                    ...
                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                        style="background-image:url('/media/stock/600x600/img-22.jpg')">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <a class="d-block card-rounded overlay"
                                                    ...
                                                    <!--begin::Image-->
                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                        style="background-image:url('/media/stock/600x600/img-21.jpg')">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                            ...
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                style="background-image:url('/media/stock/600x600/img-20.jpg')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="row g-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay h-lg-100"
                                            ...
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                style="background-image:url('/media/stock/600x600/img-11.jpg')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="row g-10 mb-10">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <a class="d-block card-rounded overlay"
                                                    ...
                                                    <!--begin::Image-->
                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                        style="background-image:url('/media/stock/600x600/img-12.jpg')">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="row g-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                            ...
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                style="background-image:url('/media/stock/600x600/img-15.jpg')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="row g-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                            ...
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                style="background-image:url('/media/stock/600x600/img-14.jpg')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="d-flex fw-semibold flex-column me-20">
                                    ...
                                    <a href="https://preview.keenthemes.com/html/metronic/docs"
                                        class="text-white opacity-50 text-hover-primary fs-5 mb-6">JDIH Kab. Magetan</a>
                                    <!--end::Link-->
                                    <!--begin::Link-->
                                ...
                                <div class="d-flex fw-semibold flex-column ms-lg-20">
									...
									<span class="text-white opacity-50 text-hover-primary fs-5" style="margin-left: 27px">hukum.setda@magetan.go.id</span>
									<br>
									<span class="text-white opacity-50 text-hover-primary fs-5" style="margin-left: 27px">(0351) 894480 - 895054 ext.249-250</span>
									<br>
									<span class="text-white opacity-50 text-hover-primary fs-5" style="margin-left: 27px">(0351) 894619 FAX</span>
                                    <!--end::Link-->
                                </div>
                                <!--end::Links-->
                            </div>
                    ...
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <div class="d-flex align-items-center order-2 order-md-1">
                            ...
                            <span class="mx-5 fs-6 fw-semibold text-gray-600 pt-1"
                                href="https://keenthemes.com">Copyright &copy; Dinas Komunikasi dan Informatika Pemerintah Kabupaten Magetan</span>
                            <!--end::Logo image-->
                        </div>
                        <!--end::Copyright-->
